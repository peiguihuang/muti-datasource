...
public class BIException extends Exception {
	...
	*            信息描述
	*/
	public BIException(String errorCode, String message) {
	...
	*            信息描述
	*/
	public BIException(String errorCode, String message, Throwable cause) {
	...
	*            消息是否为属性文件中的Key
	*/
	public BIException(String errorCode, String message, boolean propertiesKey) {
		super(message);
	...
	*            信息描述
	*/
	public BIException(String errorCode, String message, Throwable cause, boolean propertiesKey) {
		super(message, cause);
		this.setErrorCode(errorCode);
		this.setPropertiesKey(propertiesKey);
	}
